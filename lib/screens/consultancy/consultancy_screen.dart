...
class ConsultancyScreen extends StatefulWidget {
  ...
  const ConsultancyScreen({super.key, this.scaffoldKey});

  @override
  State<ConsultancyScreen> createState() => _ConsultancyScreenState();
}
...
class _ConsultancyScreenState extends State<ConsultancyScreen> {
  ...
  Widget _buildConsultancyCard(dynamic consultancy) {
    return Card(
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  CommissionConfigScreen(consultancy: consultancy),
            ),
          );
        },
        borderRadius: BorderRadius.circular(8),
