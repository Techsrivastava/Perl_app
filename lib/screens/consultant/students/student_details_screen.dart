  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          if (!_isEditing &&
              (widget.student['status'] == 'Lead' ||
                  widget.student['status'] == 'Reverted'))
            IconButton(
  ...
  Widget _buildDocCard(String name, bool uploaded) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: uploaded ? Colors.green : Colors.grey[200]!),
      ),
      child: Row(
        children: [
          Icon(
