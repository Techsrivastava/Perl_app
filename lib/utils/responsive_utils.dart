...
class ResponsiveUtils {
  ...
  static EdgeInsets getScreenPadding(BuildContext context) {
    ...
    if (width < mobileMaxWidth) return const EdgeInsets.symmetric(horizontal: 16.0, vertical: 12.0);
    if (width < tabletMaxWidth) return const EdgeInsets.symmetric(horizontal: 24.0, vertical: 16.0);
